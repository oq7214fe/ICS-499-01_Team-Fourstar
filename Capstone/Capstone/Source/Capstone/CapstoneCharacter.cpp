...
void ACapstoneCharacter::UpdateAnimation()
{
...
void ACapstoneCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Jump on any touch
	Jump();
}

void ACapstoneCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Cease jumping once touch stopped
	StopJumping();
}

void ACapstoneCharacter::UpdateCharacter()
{
